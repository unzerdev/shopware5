...
class PaylaterDirectDebitSecuredStatusMapper extends AbstractStatusMapper implements StatusMapperInterface
{
    ...
    public function getTargetPaymentStatus(Payment $paymentObject, ?bool $isWebhook = false): int
    {
        ...
        if ($paymentObject->isCanceled()) {
            ...
            throw new StatusMapperException(PaylaterDirectDebit::getResourceName(), $paymentObject->getStateName());
        }
