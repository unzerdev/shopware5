...
/**
 * @property Cancellation $resource
 */
class ChargebackHandler extends AbstractWebhookHandler
{
    ...
    public function execute(WebhookStruct $webhook): void
    {
        ...
        $this->orderStatusService->updatePaymentStatusByChargeback($this->resource);
    }
}
