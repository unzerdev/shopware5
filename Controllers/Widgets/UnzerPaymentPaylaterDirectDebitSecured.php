...
class Shopware_Controllers_Widgets_UnzerPaymentPaylaterDirectDebitSecured extends AbstractUnzerPaymentController
{
    use CanAuthorize;
    ...
    public function createPaymentAction(): void
    {
        try {
            ...
            $this->getApiLogger()->logException('Error while creating paylater direct debit secured payment', $apiException);
            ...
            $redirectUrl = $this->handleEmptyRedirectUrl(!empty($redirectUrl) ? $redirectUrl : '', 'PaylaterDirectDebitSecured');
