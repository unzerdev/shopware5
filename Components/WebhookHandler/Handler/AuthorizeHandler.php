...
/**
 * @property Authorization $resource
 */
class AuthorizeHandler extends AbstractWebhookHandler
{
    ...
    public function execute(WebhookStruct $webhook): void
    {
        ...
        $this->orderStatusService->updatePaymentStatusByAuthorization($this->resource);
    }
}
