        ...
        <div class="col-12">
            ...
            >
                ...
                {if not $isDefaultShop}
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="inheritPaymentProcessingCertificates" value="1"> {s name="inheritCertificatesLabel" namespace="backend/unzer_payment/apple_pay_certificate_manager"}{/s}
                        </label>
                    </div>
                {/if}
                ...
                {if not $isDefaultShop}
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="inheritMerchantCertificates" value="1">
