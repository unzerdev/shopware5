...
class HirePurchaseValidator extends AbstractPaymentValidator implements PaymentValidatorInterface
{
    protected const PAYMENT_METHOD_SHORT_NAME = PaymentMethods::PAYMENT_NAME_HIRE_PURCHASE;
